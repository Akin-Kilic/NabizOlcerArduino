...
int Threshold = 520; // Yazının başında belirlemiş olduğumuz eşik değerini bu değişkene atıyoruz.
...
void setup() {
  ...
  myGLCD.print((char *)"Dakikadaki", CENTER, 0);
  myGLCD.print((char *)"Nabziniz:", CENTER, 15); //Ekrana dakikadaki nabzınız yazdırıyoruz.
